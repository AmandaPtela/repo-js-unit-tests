...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
    ...
    test('Verifica se, caso o parâmetro passado não seja um número, a função retorne undefined', () => {
    ...
    test('Verifica que, caso a função não receba numnhum parâmetro, retorne undefined' , () => {
